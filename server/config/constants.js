...
const DEV_FOLDER_ID = '90115096402';
const PRODUCT_FOLDER_ID = '90116436231';
const SPRINT_CUSTOM_FIELD_ID = 'eaec1223-07ff-4ab6-bc9a-10dee0328b0d';

// Label ID -> Sprint Name Mapping
const FIELD_ID_TO_SPRINT = {
  ...
  '7cf57f5a-bd38-4a3c-a087-5c2bd0828780': 'Sprint 19 (12/31 - 1/13)',
  '226111f3-2715-4a22-bffe-d07c7b2521cb': 'Sprint 20 (1/14 - 1/27)',
  '5d92f106-407d-45f7-9add-3a5278ca9d2b': 'Sprint 21 (1/28 - 2/10)',
  '18d4d4f3-6dd6-48ed-93c7-85b1b8913064': 'Sprint 22 (2/11 - 2/24)',
};

// Reusable headers for ClickUp API
const HEADERS = {
...
const MAX_INPUT_TOKENS = 190000;
const TOKENS_PER_ITEM_EST = 100;

// System prompt for Claude defining the formatting and tone of the release notes
const SYSTEM_PROMPT =
