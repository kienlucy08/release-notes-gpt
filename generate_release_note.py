...
system_prompt = (
    ...
    "• A bolded title (the name of the bug or feature)\n"
    ...
    "Use bullet points for both details and user impact, and ensure output looks like a professional, formatted changelog. "
